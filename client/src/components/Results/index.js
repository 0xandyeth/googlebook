                    ...
                    <h1 className="text-center">No Results to Display</h1>
                        ...
                        <div>
                            {this.props.books.map(result => (
                                <div className="card mb-3 card-effect" key={result._id}>
                                    <div className="row">
                                        ...
                                        <div className="col-md-10">
                                            <div className="card-body">
                                                ...
                                                <div>
                                                    <a href={result.link} className="btn badge-pill btn-outline-dark mt-3" target="_blank" ><span style={{fontWeight:'bold'}}>View</span></a>
